          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className={`text-primary-foreground/60 hover:text-primary-foreground hover:bg-white/10 ${hasPin ? 'text-primary-foreground' : ''}`}
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
            ...
            <TooltipContent>
              {hasPin ? "Update PIN" : "Set PIN for kid login"}
            </TooltipContent>
          </Tooltip>
